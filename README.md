...
```bash
git clone https://github.com/WINGFO-HQ/OpenLedger-BOT.git
cd OpenLedger-BOT
```
...
- Go to extension OpenLedger
- Right-click and select 'Inspect Popup' to open Developer Tools
- Go to Network tab
...
3. Edit required files in the project root:
   ...
   - `address.txt`: Put your wallet address here
